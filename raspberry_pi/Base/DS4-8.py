...
# axis1:center axis2:左右(y軸回転) axis5:上下(x軸回転)
        ...
        buttonr1 = joystick.get_button( 5 )
        buttonr2 = joystick.get_button( 7 )
        button = buttonb + 2*buttonm + 4*buttonr1 +8*buttonr2




    high.trns(axis1,axis1,axis2,axis2,axis5,axis5,button,button)
    #sleep(0.1)
    clock.tick(300)
