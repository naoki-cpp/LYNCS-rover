...
# axis1:center axis2:左右(y軸回転) axis5:上下(x軸回転)
    ...
    get_calib_param()
    readData()
    height = pow(1013.25/sPressure, 1/5.256) * ( pow(sPressure/(pressure/100), 1/5.256) - 1.0 ) * (temperature + 273.15) / 0.0065
    test.trns(axis1,axis1,axis5,axis5,axis2,axis2,axis0,axis0,button,button)
    clock.tick(300)
    print(height)
    if button == 2:
     print("===============================================")
